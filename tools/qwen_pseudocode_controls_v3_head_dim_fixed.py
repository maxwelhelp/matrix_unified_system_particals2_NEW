...
def main() -> None:
    ...
    ap.add_argument("--mode", default="all", choices=["causal_path", "logit_attr", "mlp_rich", "token_control", "baselines", "all"])
    ...
    for sub in ["token_control", "causal_path", "logit_attr", "mlp_rich", "baselines"]:
